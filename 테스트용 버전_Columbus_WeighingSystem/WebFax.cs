...
namespace WeighingSystem
{
    class WebFax
    {
        ...
        /// 연동신청시 발급받은 링크아이디
        /// </summary>
        private string LinkID = "NFREEST";

        /// <summary>
        /// 연동신청시 발급받은 비밀키
        /// </summary>
        private string SecretKey = "jWQEJiXD9nWZgwUWSoZMA8Bsg/J1xg3vvgxjhllcTP4=";
        /// <summary>
        /// 팝빌회원 사업자번호
        /// </summary>
        private string corpNum = "7198803017";

        /// <summary>
        /// 팝빌회원 아이디
        /// </summary>
        private string userID = "nfreest";
